...
<head>
    <meta charset="utf-8" />
    <title>Новости</title>
    <meta name="description" content="Новости ресторана Флагман" />
                ...
                <div class="row">
                    <div class="col-md-12">
                        <nav class="navigation cl-effect-17" id="cl-effect-17">
                            <ul>
                                <li><a href="http://www.flagmanrest.ru/#menu" class="nav cl-effect-17">Меню</a></li>
                                <li><a href="http://www.flagmanrest.ru/#about" class="nav cl-effect-17">О нас</a></li>
                                <li><a href="http://www.flagmanrest.ru/#news" class="nav cl-effect-17">Новости</a></li>
                ...
                <div class="content news-content">
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <img src="/uploads/news/original/{{ $record->image }}" class="img" />
                        </div>
                        <div class="col-md-6 col-sm-6">
                            {!! $record->body !!}
                        </div>
